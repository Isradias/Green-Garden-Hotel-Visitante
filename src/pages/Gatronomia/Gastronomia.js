...
function Gastronomia (){
    return(
        <div>
            <Video src= {`${process.env.PUBLIC_URL}/videos/hotel_gastronomia.mp4`} titulo='GASTRONOMIA'></Video>
            <div className={styles.container}>
                ...
                <img src={`${process.env.PUBLIC_URL}/images/Gastronomia/restaurante.jpg`} alt='restaurante' />
            </div>
